...
plot_simulacao(controle,saida,referencia,'Sinal de Saída e Controle P e D na Realimentação');

simula_div_acao_pond2();
[mse_pond2,control_pond2] = calcula_metricas(controle,saida,referencia);
plot_simulacao(controle,saida,referencia,'Sinal de Saída e Controle P e D Ponderados');
